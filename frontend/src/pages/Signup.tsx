        ...
        .then((response) => {
            if (response) {
                ...
                .then((response) => {
                    ...
                    console.log(error);
                    setSignupMessage("Se produjo un error durante el registro. Por favor, inténtelo de nuevo más tarde.");
                });

                setSignupMessage("Registro exitoso. Bienvenido, " + response.user.username);
            } else {
                setSignupMessage("Registro fallido. Inténtalo de nuevo.");
            }
        }).catch((error) => {
            console.log(error);
            setSignupMessage("Se produjo un error durante el registro. Por favor, inténtelo de nuevo más tarde.");
