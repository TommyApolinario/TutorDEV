...
class ListDocuments(GenericAPIView):
    serializer_class = ChatSerializer
    @swagger_auto_schema(
    ...
    def post(self, request, *args, **kwargs):
        response_data = ["string1", "string2"]
        return Response(response_data, status=status.HTTP_200_OK)

    @swagger_auto_schema(
        operation_description="Retrieve an array with two strings",
        responses={
            200: openapi.Response(
                description="Array retrieved successfully",
                examples={
                    "application/json": ["string1", "string2"]
                }
            ),
    ...
    def get(self, request, *args, **kwargs):
        # Crear el array con dos strings
        response_data = ["string1", "string2"]
        
        # Retornar la respuesta con el array
        return Response(response_data, status=status.HTTP_200_OK)
